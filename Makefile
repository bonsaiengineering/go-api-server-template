...
LD_FLAGS:="-X github.com/bonsaiengineering/go-api-server-template/pkg/version.BuildVersion=$(BUILD_VERSION) \
		  -X github.com/bonsaiengineering/go-api-server-template/pkg/version.BuildBranch=$(BUILD_BRANCH)"
